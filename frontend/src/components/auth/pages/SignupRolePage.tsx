...
export function SignupRolePage() {
  ...
  return (
    <div className="flex flex-col w-full h-full">
      ...
      {/* Main Content - 고정 높이 + 스크롤 (역할 선택 버튼들) */}
      <main className="flex-shrink-0 overflow-y-auto px-5" style={{ height: 'calc(100vh - 260px)' }}>
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 mt-4 w-full pb-4">
          <Controller
            control={control}
            name="role"
            render={({ field }) => (
